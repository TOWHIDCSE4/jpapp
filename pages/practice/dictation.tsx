...
const DictationConfigPage: React.FC = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>{language === 'zh' ? 'ja' : 'Dictation Practice'}</title>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-text-primary mb-4 font-display">
              {language === 'zh' ? 'ja' : 'Kana Dictation Practice'}
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <Card className="h-fit">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="text-lg font-semibold text-text-primary">
                  {language === 'zh' ? 'js' : 'Select Kana Categories'}
                </h3>
              </div>
              <CategorySelector
            ...
            <Card className="h-fit">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="text-lg font-semibold text-text-primary">
                  {language === 'zh' ? 'jsk' : 'Practice Duration'}
                </h3>
              </div>
          ...
          <div className="text-center mt-8">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                ...
                {language === 'zh' ? 'dd' : 'Start Dictation'}
              </Button>
              <Button
                variant="outline"
                size="lg"
